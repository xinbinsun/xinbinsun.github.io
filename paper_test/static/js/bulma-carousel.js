...
var Coordinate = function () {
	...
	_createClass(Coordinate, [{
		...
		value: function inside(northwest, southeast) {
			if (this._x >= northwest._x && this._x <= southeast._x && this._y>= northwest._y && this._y <= southeast._y) { return true; } false; }, key: 'constrain', value: function constrain(min, max) if (min._x> max._x || min._y > max._y) {
				return this;
			}
...
var bulmaCarousel = function (_EventEmitter) {
  ...
  _createClass(bulmaCarousel, [{
    ...
    value: function show(index) {
      ...
      if (!this.state.length || this.state.length <= this.slidestoshow) { return; } if (typeof index="==" 'number') this.state.next="index;" (this.options.loop) this._loop.apply(); (this.options.infinite) this._infinite.apply(); new slide is already the current one then return (this.state.index="==" this.state.next) this.emit('before:show', this.state); this._transitioner.apply(force, this._setheight.bind(this)); this.emit('after:show', this.emit('show', this); }, key: 'reset', value: function reset() var _this5="this;" this.state="{" length: this._items.length, index: math.abs(this.options.initialslide), next: prev: undefined }; fix options (this.options.loop && this.options.infinite) this.options.loop="false;" (this.options.slidestoscroll> this.options.slidesToShow) {
      ...
      if (this.state.length <= this.slidestoshow) { this.state.index="0;" } this._ui.wrapper.appendchild(this._navigation.init().render()); this._ui.wrapper.appendchild(this._pagination.init().render()); if (this.options.navigationswipe) this._swipe.bindevents(); else this._swipe._bindevents(); this._breakpoint.apply(); move all created slides into slider this._slides.foreach(function (slide) return _this5._ui.container.appendchild(slide); }); this._transitioner.init().apply(true, this._setheight.bind(this)); (this.options.autoplay) this._autoplay.init().start(); ** * destroy @method }, key: 'destroy', value: function destroy() var _this6="this;" this._unbindevents(); this._items.foreach(function (item) _this6.element.appendchild(item); this.node.remove(); 'id', get: get() this._id; 'index', set: set(index) this._index="index;" this._index; 'length', set(length) this._length="length;" this._length; 'slides', this._slides; set(slides) this._slides="slides;" 'slidestoscroll', this.options.effect="==" 'translate' ? this._breakpoint.getslidestoscroll() : 1; 'slidestoshow', this._breakpoint.getslidestoshow() 'direction', this.element.dir.tolowercase()="==" 'rtl' || this.element.style.direction="==" 'ltr'; 'wrapper', this._ui.wrapper; 'wrapperwidth', this._wrapperwidth 0; 'container', this._ui.container; 'containerwidth', this._containerwidth 'slidewidth', this._slidewidth 'transitioner', this._transitioner; }], [{ 'attach', attach() _this7="this;" selector="arguments.length"> 0 && arguments[0] !== undefined ? arguments[0] : '.slider';
      var options = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
...
var Breakpoints = function () {
	...
	_createClass(Breakpoints, [{
		...
		value: function apply() {
			...
			if (this.slider.state.length <= 10 this._currentbreakpoint.slidestoshow) { this.slider.state.index="0;" } if (this.options.loop) this.slider._loop.init().apply(); (this.options.infinite) this.slider._infinite.init().apply(); this.slider._setdimensions(); this.slider._transitioner.init().apply(true, this.slider._setheight.bind(this.slider)); this.slider._setclasses(); this.slider._navigation.refresh(); this.slider._pagination.refresh(); }, key: onresize, value: function value(e) var newbreakpoint="this._getActiveBreakpoint();" (newbreakpoint.slidestoshow !="=" this._currentbreakpoint="newBreakPoint;" this.apply(); }]); return breakpoints; }(); * harmony default export __webpack_exports__["a"]="(Breakpoints);" *** }), (function(module, __webpack_exports__, __webpack_require__) "use strict"; _createclass="function" () defineproperties(target, props) for (var i="0;" < props.length; i++) descriptor="props[i];" descriptor.enumerable="descriptor.enumerable" || false; descriptor.configurable="true;" ("value" in descriptor) descriptor.writable="true;" object.defineproperty(target, descriptor.key, descriptor); (constructor, protoprops, staticprops) (protoprops) defineproperties(constructor.prototype, protoprops); (staticprops) defineproperties(constructor, staticprops); constructor; }; _toconsumablearray(arr) (array.isarray(arr)) arr2="Array(arr.length);" arr.length; arr2[i]="arr[i];" arr2; else array.from(arr); _classcallcheck(instance, constructor) (!(instance instanceof constructor)) throw new typeerror("cannot call a class as function"); infinite="function" infinite(slider) _classcallcheck(this, infinite); this.slider="slider;" _createclass(infinite, [{ 'init', init() (this.slider.options.infinite && this.slider.options.effect="==" 'translate') (this.slider.options.centermode) this._infinitecount="Math.ceil(this.slider.slidesToShow" + this.slider.slidestoshow 2); frontclones="[];" slideindex="0;"> this.slider.state.length - 1 - this._infiniteCount; i -= 1) {
					slideIndex = i - 1;
		...
		value: function apply() {
			if (this.slider.options.loop) {
				if (this.slider.state.next > 0) {
					...
					if (this.slider.state.next <= 0 12 - this.slider.slidestoscroll) { this.slider.state.next="this.slider.state.length" this.slider.slidestoshow; } else }]); return loop; }(); * harmony default export __webpack_exports__["a"]="(Loop);" *** }), (function(module, __webpack_exports__, __webpack_require__) "use strict"; (binding) __webpack_require__.d(__webpack_exports__, "a", function() isinviewport; }); var isinviewport="function" isinviewport(element, html) rect="element.getBoundingClientRect();" html="html" || document.documentelement; rect.top>= 0 && rect.left >= 0 && rect.bottom <= 13 (window.innerheight || html.clientheight) && rect.right <="(window.innerWidth" html.clientwidth); }; *** }), * (function(module, __webpack_exports__, __webpack_require__) { "use strict"; harmony import var __webpack_imported_module_0__templates_navigation__="__webpack_require__(14);" __webpack_imported_module_1__utils_detect_supportspassive__="__webpack_require__(1);" _createclass="function" () function defineproperties(target, props) for (var i="0;" props.length; i++) descriptor="props[i];" descriptor.enumerable="descriptor.enumerable" false; descriptor.configurable="true;" if ("value" in descriptor) descriptor.writable="true;" object.defineproperty(target, descriptor.key, descriptor); } return (constructor, protoprops, staticprops) (protoprops) defineproperties(constructor.prototype, protoprops); (staticprops) defineproperties(constructor, staticprops); constructor; }(); _classcallcheck(instance, constructor) (!(instance instanceof constructor)) throw new typeerror("cannot call a class as function"); navigation="function" navigation(slider) _classcallcheck(this, navigation); this.slider="slider;" this._clickevents="['click'," 'touch']; this._supportspassive="Object(__WEBPACK_IMPORTED_MODULE_1__utils_detect_supportsPassive__["a"" default ])(); this.onpreviousclick="this.onPreviousClick.bind(this);" this.onnextclick="this.onNextClick.bind(this);" this.onkeyup="this.onKeyUp.bind(this);" _createclass(navigation, [{ key: 'init', value: init() this.node="document.createRange().createContextualFragment(Object(__WEBPACK_IMPORTED_MODULE_0__templates_navigation__["a"" ])(this.slider.options.icons)); this._ui="{" previous: this.node.queryselector('.slider-navigation-previous'), next: this.node.queryselector('.slider-navigation-next') this._unbindevents(); this._bindevents(); this.refresh(); this; }, 'destroy', destroy() '_bindevents', _bindevents() _this="this;" this.slider.wrapper.addeventlistener('keyup', this.onkeyup); this._clickevents.foreach(function (clickevent) _this._ui.previous.addeventlistener(clickevent, _this.onpreviousclick); _this._ui.next.addeventlistener(clickevent, _this.onnextclick); }); '_unbindevents', _unbindevents() _this2="this;" this.slider.wrapper.removeeventlistener('keyup', _this2._ui.previous.removeeventlistener(clickevent, _this2.onpreviousclick); _this2._ui.next.removeeventlistener(clickevent, _this2.onnextclick); 'onnextclick', onnextclick(e) (!this._supportspassive) e.preventdefault(); (this.slider.options.navigation) this.slider.next(); 'onpreviousclick', onpreviousclick(e) this.slider.previous(); 'onkeyup', onkeyup(e) (this.slider.options.keynavigation) (e.key="==" 'arrowright' e.key="==" 'right') else 'arrowleft' 'left') 'refresh', refresh() let centeroffset="Math.floor(this.options.slidesToShow" 2); (!this.slider.options.loop !this.slider.options.infinite) (this.slider.options.navigation this.slider.state.length> this.slider.slidesToShow) {
	...
	_createClass(Pagination, [{
		...
		value: function _draw() {
			...
			if (this.slider.options.pagination && this.slider.state.length > this.slider.slidesToShow) {
				for (var i = 0; i <= 1 16 this._count; i++) { var newpagenode="document.createRange().createContextualFragment(Object(__WEBPACK_IMPORTED_MODULE_1__templates_pagination_page__["a"" * default ])()).firstchild; newpagenode.dataset.index="i" this.slider.slidestoscroll; this._pages.push(newpagenode); this._ui.container.appendchild(newpagenode); } this._bindevents(); }, key: 'onpageclick', value: function onpageclick(e) if (!this._supportspassive) e.preventdefault(); this.slider.state.next="e.currentTarget.dataset.index;" this.slider.show(); 'onresize', onresize() this._draw(); 'refresh', refresh() _this3="this;" newcount="void" 0; (this.slider.options.infinite) - this.slider.slidestoscroll); else this.slider.slidestoshow) (newcount !="=" this._count) this._count="newCount;" this._pages.foreach(function (page) page.classlist.remove('is-active'); (parseint(page.dataset.index, 10)="==" _this3.slider.state.next % _this3.slider.state.length) page.classlist.add('is-active'); }); 'render', render() return this.node; }]); pagination; }(); harmony export __webpack_exports__["a"]="(Pagination);" *** }), (function(module, __webpack_exports__, __webpack_require__) "use strict"; () "<div class="\"slider-pagination\"">";
});
...
/* harmony default export */ __webpack_exports__["a"] = (function (id) {
  return "<div id="\""" + "\" class="\"slider\"" tabindex="\"0\"">\n    <div class="\"slider-container\""></div>\n  </div>";
});
